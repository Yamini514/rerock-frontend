...
const items = [
  { key: "dashboard", label: "Dashboard", href: "/agent/dashboard", icon: LayoutDashboard },
  { key: "leads", label: "Leads", href: "/agent/leads", icon: Users },
  { key: "clients", label: "Clients", href: "/agent/clients", icon: User },
  { key: "notifications", label: "Notifications", href: "/agent/notifications", icon: Bell },
          ...
          return (
            <Link key={item.key} href={item.href} className="flex flex-1 flex-col items-center justify-center gap-1 py-2.5">
              ...
              >
                {active && (
                  <motion.span
                    layoutId={`agent-mobile-active-${layoutId}`}
